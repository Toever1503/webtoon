...
const filterOrder = async (input: IOrderFilterInput, page: number, size: number = 10) => mangaAxios.post(`${basePath}/filter?page=${page}&size=${size}&sort=createdAt,desc`, input);
